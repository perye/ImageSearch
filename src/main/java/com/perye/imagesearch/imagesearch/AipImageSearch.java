package com.perye.imagesearch.imagesearch;

import com.perye.imagesearch.client.BaseClient;
import com.perye.imagesearch.error.AipError;
import com.perye.imagesearch.http.AipRequest;
import com.perye.imagesearch.util.Base64Util;
...
public class AipImageSearch extends BaseClient {
     ...
     * @return JSONObject
     */
    public JSONObject sameHqUpdateContSign(String contSign, HashMap<String, String> options) {
        AipRequest request = new AipRequest();
        preOperation(request);
     ...
     * @return JSONObject
     */
    public JSONObject productUpdateContSign(String contSign, HashMap<String, String> options) {
        AipRequest request = new AipRequest();
        preOperation(request);
